# Quy Tắc Dịch Truyện (Translation Rules)

## Mục Đích
File này chứa các quy tắc và ngữ cảnh cần tuân thủ khi dịch truyện. Mọi yêu cầu dịch thuật trong workspace này đều phải tuân theo các quy tắc bên dưới.

---

## 1. Quy Tắc Dịch Thuật Chung
...
- Thể hiện cách nói chuyện đặc trưng của nhân vật **Shii** (bắt buộc viết chữ hoa và chữ thường xen kẽ trong toàn bộ câu thoại, ví dụ: `"ChỦ nhÂn đÓi bỤng nhỚ Ăn thẬt nhIỀu vÀo nHa~!"`) giống như các chương đã có.
...
- **Khi Refi nói chuyện trong gia đình**: Bắt buộc dùng **"chị - em"** khi nói chuyện với các cô gái khác (Illuna, Shii, Enne, Lyuu, Leila, Neru, Rei, Rui, Rou...); tự xưng là **"chị"**, gọi đối phương là **"em" / "các em" / "mấy đứa"**.
...
|---|---|---|---|---|
| Yuki | Illuna | anh | em | quan hệ anh em |
| Yuki | Shii | anh | em | quan hệ anh em |
| Yuki | Enne | anh | em | quan hệ anh em |
| Yuki | Neru | anh | em / em ấy (nhắc đến) | quan hệ anh em (khi hội thoại: anh - em; khi suy nghĩ/nhắc tới: em ấy) |
...
| Lyuu | Yuki | em | anh / chủ nhân | quan hệ vợ chồng (khi đã kết hôn dùng anh thay vì ngài) |
| Yuki | Leila | anh | em / em ấy (nhắc đến) | quan hệ vợ chồng (khi đã tỏ tình từ c459, hội thoại: anh - em; suy nghĩ/nhắc tới: em ấy/Leila) |
...
| Refi | Neru | chị | em | quan hệ chị em / thân thiết |
| Neru | Refi | em | chị / Refi | quan hệ chị em / thân thiết |
...
| Doda | Enne / Zaien | ta | Zaien-jouchan | Vua Dwarf gọi Zaien |
...
| 大太刀 / 大剣 | đại kiếm | Vũ khí | Dùng 'đại kiếm', không dùng 'đại thái đao' |
...
| クリムゾン・イービル・サーペントキング | Xích Ác Xà Vương | Chủng tộc | Chủng tộc tiến hóa của Orochi |
| ノワル・クロウ | Hắc Quạ | Chủng tộc | Quạ đen ma thú (Yata) |
| ナハトキング・クロウ | Dạ Vương Quạ | Chủng tộc | Chủng tộc tiến hóa của Yata |
| 化け猫 | Linh Miêu | Chủng tộc | Mèo hai đuôi ma thú (Byaku) |
| 大化け猫 | Đại Linh Miêu | Chủng tộc | Chủng tộc tiến hóa của Byaku |
| 水精霊 | Thủy Tinh Linh | Chủng tộc | Khối nước ma thú (Seimi) |
| ウンディーネ | Undine | Chủng tộc | Chủng tộc tiến hóa của Seimi |
...
> **Hướng dẫn cập nhật**: Khi cần thêm cách xưng hô cho bộ hoặc tên nhân vật hoặc thuật ngữ cho bộ truyện mới, hãy cập nhật phần "3. Quy Tắc Xưng Hô", "4. Quy Tắc Tên Nhân Vật" và "5. Quy Tắc Dịch Tên Riêng & Thuật Ngữ".
